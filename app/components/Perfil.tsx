...
import CreateSub from '../pages/standard-user/create-sub/page';
                ...
                <div className="profile">
                    ...
                    Datos: {user ? user.email : 'Loading...'} 
                        <div className="profile-bio">
                            ...
                            <button onClick={handleOpenModal} className="disabled:opacity-70 disabled:cursor-not-allowed rounded-md hover:opacity-80 transition w-full border-slate-700 flex items-center justify-center gap-2">Crear Sub</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="containerPerfil">
            ...
            {isCreateSubModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-10">
                    <div className="bg-white p-5 rounded-lg shadow-lg w-[90%] max-w-md">
                        <CreateSub/>
                        {/* Agrega aquí el contenido para crear la suscripción */}
                        {/* Botón para cerrar el modal */}
                        <button onClick={handleCloseModal} className="mt-3 px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600">Cerrar</button>
                    </div>
                </div>
